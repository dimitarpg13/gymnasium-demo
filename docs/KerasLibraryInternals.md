...
## <a id="the-node-class"></a>The Node class

[Go back to Contents](#contents)

Excerpt from `keras/src/ops/node.py`:
```python
class Node:
...
```
[Go back to the beginning of the Section](#the-node-class)

## <a id="keras-tensor"></a>Keras Tensor

[Go back to Contents](#contents)

Excerpt from `keras/src/backend/common/keras_tensor.py`:
```python
...
[Go back to the beginning of the Section](#keras-tensor)
